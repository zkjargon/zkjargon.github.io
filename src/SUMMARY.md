...
# Definitions
- [Accumulation (Proof Composition Technique)](./definitions/accumulation.md)
...
- [Folding Scheme](./definitions/folding_scheme.md)
- [Incrementally-Verifiable Computation](./definitions/incrementally_verifiable_computation.md)
...
- [Pairing](./definitions/pairing.md)
- [PLONKish Arithmetization](./definitions/plonkish.md)
...
- [Proof-Carrying Data](./definitions/proof_carrying_data.md)
...
- [Recursion](./definitions/recursion.md)
